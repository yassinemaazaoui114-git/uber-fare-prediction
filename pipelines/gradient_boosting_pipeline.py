...
class GradientBoostingPipeline:
    ...
    def _tune_hyperparameters(self, X_train, y_train):
        ...
        self.best_params = gb_search.best_params_

        # Update pipeline with best model
        self.pipeline.named_steps["model"] = gb_search.best_estimator_
    ...
    def save_model(self, filepath="models/gradient_boosting_model.joblib"):
        """Save the trained model"""
        joblib.dump(self.pipeline, filepath)
        print(f"✅ {self.model_name} saved to {filepath}")

    def load_model(self, filepath="models/gradient_boosting_model.joblib"):
